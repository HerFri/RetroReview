...
def edit_comment(request, comment_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return redirect('review_detail', game=comment.review.game.slug,
                            review=comment.review.slug,)
    else:
...
def filter_games(request):
    ...
    return render(request, "filtered_games.html",
