...
urlpatterns = [
    ...
    path('game/detail/<slug:slug>/', views.GameDetail.as_view(),
         name='game_detail'),
    path('<slug:game>/<slug:review>/', views.ReviewDetail.as_view(),
         name='review_detail'),
    path('like/<slug:game>/<slug:review>', views.ReviewLike.as_view(),
         name='review_like'),
